...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference("Resume.count") do
      post resumes_url, params: { resume: { attribute_name: @resume.attribute_name, file_name: @resume.file_name } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { attribute_name: @resume.attribute_name, file_name: @resume.file_name } }
